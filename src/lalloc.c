...
void
allocator_free(struct allocator *A) {
...
static inline void *
chunk_new(struct allocator *A, int sz) {
...
static void *
memory_alloc_small(struct allocator *A, int n) {
...
static inline void
memory_free_small(struct allocator *A, struct smallblock *ptr, int n) {
  ptr->next = A->small_list[n];
  A->small_list[n] = ptr;
}

static void *
memory_alloc_huge(struct allocator *A, size_t sz) {
...
static void
memory_free_huge(struct allocator *A, struct hugeblock *ptr) {
  --ptr;
...
static void *
memory_alloc_big(struct allocator *A, int sz) {
...
static inline void
memory_free_big(struct allocator *A, void *ptr) {
...
static void *
memory_realloc_huge(struct allocator *A, void *ptr, size_t nsize) {
